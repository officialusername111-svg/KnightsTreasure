...
export const ITEMS = {
  ...
  // TEMP-DEMO (REVERT BEFORE COMMIT): unlockStage of arrow/torch/eagleEye/shield/spear/
  // holyWater/sword/bomb/warHorn lowered to 1 so the T2 effect walkthrough works on Stage 1.
  // Real values: arrow 3, torch 4, eagleEye 5, shield 6, spear 7, holyWater 7, sword 8, bomb 9, warHorn 10.
  arrow:       { id: 'arrow',       name: 'Arrow',          icon: 'ui_power_arrow',        category: 'powerup', cost: 35,  unlockStage: 1,  timer: false, effect: 'Permanently reveal one tile. (−25 score)' },
  torch:       { id: 'torch',       name: 'Torch',          icon: 'ui_power_torch',        category: 'powerup', cost: 50,  unlockStage: 1,  timer: false, effect: 'Reveal every tile for 2 seconds.' },
  eagleEye:    { id: 'eagleEye',    name: 'Eagle Eye',      icon: 'ui_power_eagle_eye',    category: 'powerup', cost: 55,  unlockStage: 1,  timer: false, effect: 'Glow all real pairs for 5 seconds.' },
  shield:      { id: 'shield',      name: 'Shield',         icon: 'ui_power_shield',       category: 'powerup', cost: 45,  unlockStage: 1,  timer: true,  effect: 'Freeze the timer for 10 seconds.' },
  spear:       { id: 'spear',       name: 'Spear',          icon: 'ui_power_spear',        category: 'powerup', cost: 40,  unlockStage: 1,  timer: false, effect: 'Reveal a row or column for 3 seconds.' },
  holyWater:   { id: 'holyWater',   name: 'Holy Water',     icon: 'ui_power_holy_water',   category: 'powerup', cost: 40,  unlockStage: 1,  timer: false, effect: 'Remove the chains from all locked tiles.' },
  sword:       { id: 'sword',       name: 'Sword',          icon: 'ui_power_sword',        category: 'powerup', cost: 65,  unlockStage: 1,  timer: false, effect: 'Permanently reveal a matching pair. (−25 score)' },
  bomb:        { id: 'bomb',        name: 'Bomb',           icon: 'ui_power_bomb',         category: 'powerup', cost: 80,  unlockStage: 1,  timer: false, effect: 'Reveal a 2×2 area permanently. (−25 score)' },
  warHorn:     { id: 'warHorn',     name: 'War Horn',       icon: 'ui_power_war_horn',     category: 'powerup', cost: 60,  unlockStage: 1,  timer: false, effect: 'Double your score for 10 seconds.' },
